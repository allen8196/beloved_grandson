    ...
    def generate_response(
        ...
        try:
            ...
            if self.api_key and self._is_api_available():
                response = self._call_openai_api(system_prompt, message)
            else:
...
- 不要超過100字
    ...
    def _call_openai_api(self, system_prompt: str, message: str) -> str:
        """
        調用OpenAI API
        """
        try:
...
if __name__ == "__main__":
    ...
    response_1 = llm_service.generate_response(test_message_1, patient_id="test_patient_001")
